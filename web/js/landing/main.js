$(document).ready(function(){
	...
	var datos = 'js/landing/noticias/noticias.json';
	var datos_concuross = 'js/landing/concursos/concursos.json';
	...
	$.getJSON(datos, function (data) {
		...
		$.getJSON(origin + "web/api/v1/concursos?institucion=1&etiquetas=1,2,3", function (data) {
...
*/
		...
		$.getJSON(origin + "web/api/v1/noticias?page=0", function (data) {
			console.log(data);
	...
	// Aliados
		...
		$.getJSON(origin + "/web/api/v1/aliados", function (data) {
			console.log(data);
/*
			for(var i = 0; i < data.length;i++){
...
*/
    ...
    $('.caption-img-box').hover(function () {
	 ...
	 $(window).scroll(function() {
		...
		if (winTop >= 550) {
			$("body").addClass("sticky-header");
			document.getElementById('imagen').src = "img/fwd1.png";
