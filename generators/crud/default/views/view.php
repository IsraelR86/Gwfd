...
<div class="<?= Inflector::camel2id(StringHelper::basename($generator->modelClass)) ?>-view">
    ...
    <p>
        ...
        <?= "<?= " ?>Html::a('<span class="glyphicon glyphicon-pencil"></span> Actualizar', ['update', <?= $urlParams ?>], ['class' => 'btn btn-primary']) ?> &nbsp; 
        <?= "<?= " ?>Html::a('<span class="glyphicon glyphicon-trash"></span> Eliminar', ['delete', <?= $urlParams ?>], [
