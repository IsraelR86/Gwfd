...
<div class="row">
    <div class="col-md-5 col-sm-4 center-block">
        <h3 class="text-center">Registro de Institución</h3>
        ...
        <?php
            ...
            <?= $form->field($model, 'nombre_institucion', [
                ...
                'inputOptions' => ['autofocus placeholder' => $model->getAttributeLabel('nombre_institucion')]
            ])->textInput() ?>

            <?= $form->field($model, 'nombre', [
                'enableLabel' => false,
                'inputTemplate' => '<span class="block input-icon input-icon-right"> {input} </span>',
                'inputOptions' => ['autofocus placeholder' => 'Nombre del administrador']
            ])->textInput() ?>
